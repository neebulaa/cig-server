...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Create Benefit</h1>
    <p class="mt-1">This page is for creating a benefit</p>
    <a href="/benefits"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/benefits" enctype="multipart/form-data">
        @csrf
