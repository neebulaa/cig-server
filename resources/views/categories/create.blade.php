...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Create category</h1>
    <p class="mt-1">This page is for creating a category</p>
    <a href="/categories"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/categories" enctype="multipart/form-data">
        @csrf
