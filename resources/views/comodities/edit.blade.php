...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Edit Comodity</h1>
    <p class="mt-1">This page is for editing a comodity</p>
    <a href="/comodities"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/comodities/{{ $comodity->slug }}"
        ...
        <div class="input-box mt-4">
            <label class="block mb-2 text-sm font-sans font-medium text-gray-900 dark:text-white" for="icon">Upload
                file</label>
            <img alt="image-preview" src="{{ $comodity->public_icon }}"
                class="image-preview w-[80px] h-[80px] max-w-full bg-black rounded-md object-contain mt-4 mb-4 block">
            <input
