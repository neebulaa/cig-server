...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Create Comodity</h1>
    <p class="mt-1">This page is for creating a comodity</p>
    <a href="/comodities"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/comodities" enctype="multipart/form-data">
        @csrf
    ...
    <script>
        ...
        name.addEventListener('change', function() {
            fetch(`/comodities/create_slug?name=${name.value}`).then(res => res.json()).then(data => slug.value =
                data
                .slug);
        });
    </script>
