...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">All Products</h1>
    <p class="mt-1">This page is for managing all products</p>
                ...
                <table class="w-full min-w-[640px] table-auto">
                    <thead>
                        <tr>
                            ...
                            <th class="border-b border-blue-gray-50 py-3 px-5 text-left max-w-[600px]">
                                <p class="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">
                                    Description
                                </p>
                            </th>
                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    <div class="flex gap-4 justify-center items-center">
                                        ...
                                        <a href="/products/edit/{{ $product->slug }}" class="block">
                                        ...
                                        <button data-modal-target="popup-modal-{{ $product->slug }}"
                                            data-modal-toggle="popup-modal-{{ $product->slug }}" type="button">
                                        ...
                                        <div id="popup-modal-{{ $product->slug }}" tabindex="-1"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    <form method="post" action="/products/{{ $product->slug }}">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal-hide="popup-modal-{{ $product->slug }}">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3
                                                                ...
                                                                this product?</h3>
                                                            <button data-modal-hide="popup-modal-{{ $product->slug }}"
                                                                type="submit"
    ...
    @else
        <h3 class="text-lg text-blue-gray-900 font-bold mt-4">Currently there is no product
            {{ request('search') ? 'with keyword ' . request('search') : '' }}</h3>
        <p>Please add some data</p>
    @endif

    @if ($products->count() && !($products->onFirstPage() && $products->onLastPage()))
        <div class="mt-4">
