...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Create Team Member</h1>
    <p class="mt-1">This page is for creating a team member</p>
    <a href="/team-members"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/team-members" enctype="multipart/form-data">
        @csrf
        ...
        <div class="input-box mt-4">
            ...
            <img alt="image-preview"
                class="bg-gray-100 image-preview w-[80px] h-[80px] p-1 max-w-full rounded-full object-cover mt-4 mb-4 hidden">
            <input
    ...
    <script>
        ...
        name.addEventListener('change', function() {
            fetch(`/team-members/create_slug?name=${name.value}`).then(res => res.json()).then(data => slug.value =
                data
                .slug);
        });
    </script>
