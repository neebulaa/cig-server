...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Edit client</h1>
    <p class="mt-1">This page is for editing a client</p>
    <a href="/clients"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/clients/{{ $client->slug }}"
        ...
        <div class="input-box mt-4">
            <label class="block mb-2 text-sm font-sans font-medium text-gray-900 dark:text-white" for="logo">Upload
                Logo</label>
            <img alt="image-preview" src="{{ $client->public_logo }}"
                class="bg-gray-100 image-preview w-[80px] h-[80px] p-1 max-w-full rounded-md object-contain mt-4 mb-4 block">
            <input
