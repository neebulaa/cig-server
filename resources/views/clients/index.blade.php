...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">All Clients</h1>
    <p class="mt-1">This page is for managing all clients</p>
    ...
    @if ($clients->count())
        ...
        <p class="mb-2 text-blue-gray-600 text-sm">Clients found: {{ $total_items }}</p>
                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    <div class="flex gap-4 justify-center">
                                        <a href="/clients/edit/{{ $client->slug }}" class="block">
                                        ...
                                        <button data-modal-target="popup-modal-{{ $client->slug }}"
                                            data-modal-toggle="popup-modal-{{ $client->slug }}" type="button">
                                        ...
                                        <div id="popup-modal-{{ $client->slug }}" tabindex="-1"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    <form method="post" action="/clients/{{ $client->slug }}">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal-hide="popup-modal-{{ $client->slug }}">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3
                                                                ...
                                                                this client?</h3>
                                                            <button data-modal-hide="popup-modal-{{ $client->slug }}"
                                                                type="submit"
    ...
    @else
        <h3 class="text-lg text-blue-gray-900 font-bold mt-4">Currently there is no client
            {{ request('search') ? 'with keyword ' . request('search') : '' }}</h3>
        <p>Please add some data</p>
    @endif

    @if ($clients->count() && !($clients->onFirstPage() && $clients->onLastPage()))
        <div class="mt-4">
            {{ $clients->links('partials.paginator') }}
        </div>
    @endif
@endsection
