...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Create Post</h1>
    <p class="mt-1">This page is for creating a post</p>
    <a href="/posts"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/posts" enctype="multipart/form-data">
        @csrf
