...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">All Posts</h1>
    <p class="mt-1">This page is for managing all posts</p>
    <a href="/posts/create"
                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    <div class="flex gap-4 justify-center items-center">
                                        ...
                                        <a href="/posts/edit/{{ $post->slug }}" class="block">
                                        ...
                                        <button data-modal-target="popup-modal-{{ $post->slug }}"
                                            data-modal-toggle="popup-modal-{{ $post->slug }}" type="button">
                                        ...
                                        <div id="popup-modal-{{ $post->slug }}" tabindex="-1"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    <form method="post" action="/posts/{{ $post->slug }}">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal-hide="popup-modal-{{ $post->slug }}">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3
                                                                ...
                                                                this post?</h3>
                                                            <button data-modal-hide="popup-modal-{{ $post->slug }}"
                                                                type="submit"
    ...
    @else
        <h3 class="text-lg text-blue-gray-900 font-bold mt-4">Currently there is no post
            {{ request('search') ? 'with keyword ' . request('search') : '' }}</h3>
        <p>Please add some data</p>
    @endif

    @if ($posts->count() && !($posts->onFirstPage() && $posts->onLastPage()))
        <div class="mt-4">
