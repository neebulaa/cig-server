...
@section('content')
    <h1 class="text-2xl text-blue-gray-900 font-bold mt-4">Edit Certification</h1>
    <p class="mt-1">This page is for editing a certification</p>
    <a href="/certifications"
        ...
        to index</a>
    <hr class="mt-4 mb-4">
    <form class="p-4 border bg-white rounded-lg" method="post" action="/certifications/{{ $certification->slug }}"
        ...
        <div class="input-box mt-4">
            <label class="block mb-2 text-sm font-sans font-medium text-gray-900 dark:text-white" for="image">Upload
                Image</label>
            <img alt="image-preview" src="{{ $certification->public_image }}"
